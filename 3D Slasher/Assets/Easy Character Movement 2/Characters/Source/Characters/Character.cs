...
namespace EasyCharacterMovement
{
    ...
    public class Character : MonoBehaviour
    {
        ...
        [Space(15f)]
        [Tooltip("Modifer to the gravity. Increases falling speed if added")]
        [SerializeField]
        ...
        public event Action JumpedPublic;
        public event Action KnockoutPublic;
        /// <summary>
        ...
        protected virtual void Falling(Vector3 desiredVelocity)
        {
            ...
            if (_applyGravity)
                characterMovement.velocity += GetGravityVector() * (deltaTime * _gravityModifier);
